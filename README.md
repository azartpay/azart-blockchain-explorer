...
Simple, database-free Azart blockchain explorer, via RPC. Built with Node.js, express, bootstrap-v4.

This tool is intended to be a simple, self-hosted explorer for the Azart blockchain, driven by RPC calls to your own bitcoind node. This tool is easy to run but currently lacks features compared to database-backed explorers.
...
* Currently supports AZART (support for any Azart-RPC-protocol-compliant coin can be added easily)

# Getting started

The below instructions are geared toward AZART, but can be adapted easily to other coins.
...
2. Synchronize your node with the Azart network.
